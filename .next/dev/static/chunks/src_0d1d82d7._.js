...
const useKDSAccessStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((set, get)=>({
        ...INITIAL_STATE,
        setAccessContext: (ctx)=>set({
                userId: ctx.userId,
                roleId: ctx.roleId,
                brandId: ctx.brandId,
                storeId: ctx.storeId,
                permissions: ctx.permissions,
                isStationMode: ctx.isStationMode ?? false,
                isBootstrapped: true
            }),
        clearAccessContext: ()=>set(INITIAL_STATE),
        hasPermission: (permission)=>{
            const { permissions, roleId } = get();
            // STORE_MANAGER and PLATFORM_SUPER_ADMIN implicitly have all permissions
            if (roleId === 'STORE_MANAGER' || roleId === 'PLATFORM_SUPER_ADMIN') {
                return true;
            }
...
"[project]/src/modules/kds/services/kdsBootstrap.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function executeKDSBootstrap() {
    const apiBase = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'http://localhost:8000/api';
    ...
    try {
        ...
        if (!response.ok) {
            ...
            if (response.status === 404 || response.status >= 500) {
                console.warn(`[KDSBootstrap] Backend returned ${response.status}, using fallback bootstrap data.`);
...
function hydrateStores(data) {
    ...
    // ── 1. Access Store ───────────────────────────────────────────────────────
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsAccessStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSAccessStore"].getState().setAccessContext({
        userId: user.user_id,
        roleId: user.role_id,
        brandId: user.brand_id,
        storeId: user.store_id,
        permissions: user.permissions,
        isStationMode: station?.is_station_mode ?? false
    });
    // ── 2. KDS Store — Routing config ─────────────────────────────────────────
    const kds = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"].getState();
    ...
    console.info(`[KDSBootstrap] ✅ Complete — user: ${user.user_id}, store: ${user.store_id}, ` + `station: ${station?.station_id ?? 'ALL'}, orders loaded: ${open_orders.length}`);
}
// ─────────────────────────────────────────────────────────────────────────────
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/kds/store/kdsStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsAccessStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/kds/store/kdsAccessStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$services$2f$kdsBootstrap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/kds/services/kdsBootstrap.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function KDSLayout({ children }) {
    ...
    const isBootstrapped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsAccessStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSAccessStore"])({
        "KDSLayout.useKDSAccessStore[isBootstrapped]": (s)=>s.isBootstrapped
    }["KDSLayout.useKDSAccessStore[isBootstrapped]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "KDSLayout.useEffect": ()=>{
            ...
            if (sessionStatus === 'authenticated' && !isBootstrapped) {
    ...
    const runBootstrap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "KDSLayout.useCallback[runBootstrap]": async ()=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$services$2f$kdsBootstrap$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["executeKDSBootstrap"])();
                setPhase('READY');
            } catch (err) {
    ...
    // If already bootstrapped (e.g., navigating between KDS sub-routes), skip
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "KDSLayout.useEffect": ()=>{
            if (sessionStatus === 'authenticated' && isBootstrapped && phase !== 'READY') {
                setPhase('READY');
            }
        }
    }["KDSLayout.useEffect"], [
    ...
    if (phase === 'CHECKING_SESSION' || sessionStatus === 'loading') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "min-h-screen flex flex-col items-center justify-center bg-slate-950 gap-6",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "relative",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-16 h-16 rounded-2xl bg-slate-800 border border-slate-700 flex items-center justify-center animate-pulse",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-[11px] font-black text-slate-500 uppercase tracking-[0.3em]",
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-[13px] font-black text-white uppercase tracking-[0.2em]",
                            children: "Initializing KDS"
                        }, void 0, false, {
                            fileName: "[project]/src/app/kds/layout.tsx",
                            lineNumber: 176,
                            columnNumber: 21
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-[10px] font-bold text-slate-600 uppercase tracking-[0.3em]",
                            children: "Loading stations, routing & open orders"
                        }, void 0, false, {
                            fileName: "[project]/src/app/kds/layout.tsx",
                            lineNumber: 179,
                            columnNumber: 21
...
_s(KDSLayout, "U4U8w/DbkRyHnsPpUG+U8jxMa/k=", false, function() {
    return [
...
//# sourceMappingURL=src_0d1d82d7._.js.map