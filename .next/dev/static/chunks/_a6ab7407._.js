...
function isKDSModuleActive(moduleFlags) {
    return moduleFlags?.module1A === true;
}
function isMessagingModuleActive(moduleFlags) {
    return moduleFlags?.module4 === true;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
const useKDSStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        addOrUpdateOrder: (order)=>set((state)=>{
                ...
                if (order.external_order_id) {
                    newExternalMap[order.external_order_id] = order.id;
                }
                return {
                    orders: {
                        ...state.orders,
        ...
        acceptOrder: (orderId)=>{
            ...
            set((state)=>{
                ...
                const prepTime = order.prepTimeMinutes || 10;
                const eta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$etaUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateETA"])(order.createdAt, prepTime);
        ...
        advanceStage: (orderId)=>{
            ...
            if (currentOrder.stage === 'READY') {
                ...
                if (!isOnline) queueAction('REMOVE_ORDER', {
                    orderId
                });
                return;
            }
        ...
        delayOrder: (orderId, additionalMinutes, role, reason)=>{
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$kdsAccess$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canDelayOrder"])(role)) {
                console.warn(`Role ${role} is not authorized to delay orders`);
                return;
            }
            const { isOnline, queueAction } = get();
            // Immediate local update (Optimistic UI)
            set((state)=>{
                ...
                const newETA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$etaUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateETA"])(order.createdAt, newTotalPrepTime);
                const delayEntry = {
            ...
            if (order?.order_source === 'UBER_DIRECT') {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$services$2f$kdsEventDispatcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emitEvent"])('order.eta_synced_to_uber', {
                    orderId,
                    additionalMinutes,
                    newETA: get().orders[orderId]?.estimatedReadyTime ?? null,
                    reason: reason ?? null
                }, {
                    idempotencyKey: `eta-sync-${orderId}-${additionalMinutes}`
                });
            }
        },
        cancelOrder: (orderId, role)=>{
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$kdsAccess$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canCancelOrder"])(role)) {
                console.warn(`Role ${role} is not authorized to cancel orders`);
                return;
            }
            const { isOnline, queueAction } = get();
            set((state)=>{
            ...
            if (!isOnline) {
                queueAction('CANCEL_ORDER', {
                    orderId
                });
            }
        },
        overrideStage: (orderId, stage, role)=>{
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$kdsAccess$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canOverrideStage"])(role)) {
                console.warn(`Role ${role} is not authorized to override stages`);
                return;
            }
        ...
        incrementPrepTime: (orderId, minutes = 5)=>{
            ...
            set((state)=>{
                ...
                const newETA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$etaUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateETA"])(order.createdAt, newPrepTime);
                return {
                    orders: {
                        ...state.orders,
                        [orderId]: {
            ...
            if (!isOnline) {
                queueAction('INCREMENT_PREP_TIME', {
                    orderId,
                    minutes
                });
            }
        ...
        sendCustomerMessage: (orderId, channel, message)=>{
            set((state)=>{
                ...
                // Emit customer notification event so WebSocket layer can route
                // to the correct channel (SMS / Email gateway)
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$services$2f$kdsEventDispatcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emitEvent"])('order.customer_notification', {
                    ...
                    idempotencyKey: `notification-${orderId}-${logEntry.sentAt}`
                });
                return {
                    orders: {
                        ...state.orders,
        ...
        replayQueuedActions: ()=>{
            ...
            // Flush each queued action through the dispatcher so it's properly
            // logged and transmitted via the WebSocket emitter when available
            pendingActions.forEach((action)=>{
                console.log(`Syncing action: ${action.type}`, action.payload);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$services$2f$kdsEventDispatcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emitEvent"])(`queue.replay.${action.type}`, {
                    originalAction: action.type,
                    originalTimestamp: action.timestamp,
                    ...action.payload
                }, {
                    idempotencyKey: `replay-${action.id}`
                });
            });
            set({
                pendingActions: []
            });
            // Update all orders to mark as synced
            set((state)=>{
                const updatedOrders = {
                    ...state.orders
                };
...
_s(KDSLayout, "BgrHhHXgN1WNfLviYBm/JKayI24=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$providers$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=_a6ab7407._.js.map