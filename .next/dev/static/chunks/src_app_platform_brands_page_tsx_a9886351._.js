...
"[project]/src/app/platform/brands/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BrandsPage() {
    ...
    const [createdDateFilter, setCreatedDateFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [provinceFilter, setProvinceFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    // Pagination
    ...
    // Suspend modal
    const [suspendTarget, setSuspendTarget] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // ── Data Fetch (mock) ─────────────────────────────────────────────────
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrandsPage.useEffect": ()=>{
            const load = {
                "BrandsPage.useEffect.load": async ()=>{
                    setIsLoading(true);
                    await new Promise({
                        "BrandsPage.useEffect.load": (r)=>setTimeout(r, 400)
                    }["BrandsPage.useEffect.load"]);
    ...
    const provinces = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BrandsPage.useMemo[provinces]": ()=>Array.from(new Set(brands.map({
                "BrandsPage.useMemo[provinces]": (b)=>b.province
            }["BrandsPage.useMemo[provinces]"]).filter(Boolean)))
    }["BrandsPage.useMemo[provinces]"], [
        brands
    ]);
    const filteredBrands = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BrandsPage.useMemo[filteredBrands]": ()=>{
            let result = [
                ...brands
            ];
            if (searchQuery) {
                ...
                result = result.filter({
                    "BrandsPage.useMemo[filteredBrands]": (b)=>b.brandName.toLowerCase().includes(q) || b.tradeName.toLowerCase().includes(q)
                }["BrandsPage.useMemo[filteredBrands]"]);
            }
            if (statusFilter !== 'all') {
                result = result.filter({
                    "BrandsPage.useMemo[filteredBrands]": (b)=>b.status === statusFilter
                }["BrandsPage.useMemo[filteredBrands]"]);
            }
            if (createdDateFilter) {
                result = result.filter({
                    "BrandsPage.useMemo[filteredBrands]": (b)=>b.createdDate >= createdDateFilter
                }["BrandsPage.useMemo[filteredBrands]"]);
            }
            if (provinceFilter !== 'all') {
                result = result.filter({
                    "BrandsPage.useMemo[filteredBrands]": (b)=>b.province === provinceFilter
                }["BrandsPage.useMemo[filteredBrands]"]);
            }
            return result;
        }
    ...
    const handleRowClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BrandsPage.useCallback[handleRowClick]": (brand)=>{
            router.push(`/platform/brands/${brand.id}`);
        }
    }["BrandsPage.useCallback[handleRowClick]"], [
        router
    ]);
    const handleSuspendConfirm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BrandsPage.useCallback[handleSuspendConfirm]": ()=>{
            if (!suspendTarget) return;
            const newStatus = suspendTarget.status === 'Active' ? 'Suspended' : 'Active';
            setBrands({
                "BrandsPage.useCallback[handleSuspendConfirm]": (prev)=>prev.map({
                        "BrandsPage.useCallback[handleSuspendConfirm]": (b)=>b.id === suspendTarget.id ? {
                                ...b,
                                status: newStatus
                            } : b
                    }["BrandsPage.useCallback[handleSuspendConfirm]"])
    ...
    const clearFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BrandsPage.useCallback[clearFilters]": ()=>{
            setSearchQuery('');
            setStatusFilter('all');
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 425,
                                columnNumber: 25
                            }, this) : filteredBrands.length === 0 ? /* Empty State */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    children: paginatedBrands.map((brand)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                    ...
                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            brand.province && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: buildPageNumbers(currentPage, totalPages).map((item, idx)=>item === '...' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            suspendTarget && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BrandsPage, "m7HScKaMcFJcOczK2GuxS/sTSJE=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "FilterSelect");
...
//# sourceMappingURL=src_app_platform_brands_page_tsx_a9886351._.js.map