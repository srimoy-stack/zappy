...
"[project]/src/modules/m9/email-campaigns/hooks/useSegmentPermissions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(useSegmentPermissions, "KgCwW9dXrZj7sH0VhCx0UPAGNX8=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$hooks$2f$useSegmentPermissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/m9/email-campaigns/hooks/useSegmentPermissions.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$services$2f$segmentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/m9/email-campaigns/services/segmentService.ts [app-client] (ecmascript)");
...
const SegmentsPage = ()=>{
    ...
    const permissions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$hooks$2f$useSegmentPermissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSegmentPermissions"])();
    ...
    const [rowLoading, setRowLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // ── Delete confirmation modal ──────────────────────────────────────
    const [deleteModal, setDeleteModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(INITIAL_DELETE_MODAL);
    const [deleteInProgress, setDeleteInProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // ── Per-row inline errors ──────────────────────────────────────────
    const [inlineErrors, setInlineErrors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const clearInlineError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SegmentsPage.useCallback[clearInlineError]": (segmentId)=>{
            setInlineErrors({
                "SegmentsPage.useCallback[clearInlineError]": (prev)=>prev.filter({
                        "SegmentsPage.useCallback[clearInlineError]": (e)=>e.segmentId !== segmentId
                    }["SegmentsPage.useCallback[clearInlineError]"])
            }["SegmentsPage.useCallback[clearInlineError]"]);
        }
    }["SegmentsPage.useCallback[clearInlineError]"], []);
    const setInlineError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SegmentsPage.useCallback[setInlineError]": (segmentId, message)=>{
            setInlineErrors({
                "SegmentsPage.useCallback[setInlineError]": (prev)=>{
                    const filtered = prev.filter({
                        "SegmentsPage.useCallback[setInlineError].filtered": (e)=>e.segmentId !== segmentId
                    }["SegmentsPage.useCallback[setInlineError].filtered"]);
                    return [
                        ...filtered,
                        {
                            segmentId,
    ...
    const handleDuplicate = async (id, originalName)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$services$2f$segmentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["segmentService"].duplicateSegment(id, copyName);
    ...
    const handleDeleteConfirm = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$services$2f$segmentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["segmentService"].deleteSegment(segmentId);
...
_s(SegmentsPage, "nnoGS/hbT4LNixavIfQnZIDs8zo=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$hooks$2f$useSegmentPermissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSegmentPermissions"],
...
//# sourceMappingURL=src_897b1408._.js.map