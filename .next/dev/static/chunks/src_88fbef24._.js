...
const segmentService = {
     ...
     */ updateSegment: async (id, data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/email-campaigns/segments/${id}`, data);
        return response.data;
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
_s(SegmentsPage, "SyUoom0y4Ti03uMLkgc9IfTtd9k=", false, function() {
    return [
...
//# sourceMappingURL=src_88fbef24._.js.map