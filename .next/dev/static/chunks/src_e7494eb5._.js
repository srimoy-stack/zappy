        ...
        "ShopHeader.useEffect": ()=>{
            if (searchQuery.length > 1) {
                const results = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$shop$2f$mock$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SHOP_ITEMS"].filter({
                    "ShopHeader.useEffect.results": (item)=>item.name.toLowerCase().includes(searchQuery.toLowerCase()) || item.description.toLowerCase().includes(searchQuery.toLowerCase())
                }["ShopHeader.useEffect.results"]).slice(0, 5);
...
_s(ShopHeader, "OIlZwghSyYFAr5rmVCWipC7VXPA=", false, function() {
    return [
...
"[project]/src/modules/shop/components/ShopFooter.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(ShopFooter, "j6lBMKypm/8zx+CA2FTOjLoV3Fs=", false, function() {
    return [
...
_c = ShopFooter;
var _c;
__turbopack_context__.k.register(_c, "ShopFooter");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_e7494eb5._.js.map