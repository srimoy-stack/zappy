...
const SegmentEditPage = ()=>{
    ...
    const [showJsonPreview, setShowJsonPreview] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // ── Fetch Segment ──────────────────────────────────────────────────
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
                ...
                "SegmentEditPage.useEffect.fetchSegment": async ()=>{
                    try {
                        ...
                        if ("TURBOPACK compile-time truthy", 1) {
                            ...
                            const seed = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$utils$2f$segmentSeeds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEV_SEED_SEGMENTS"].find({
                                "SegmentEditPage.useEffect.fetchSegment.seed": (s)=>s.id === segmentId
                            }["SegmentEditPage.useEffect.fetchSegment.seed"]);
                            if (seed) {
    ...
    const rulesJsonOutput = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SegmentEditPage.useMemo[rulesJsonOutput]": ()=>{
            if (!segment || !segment.rules_json) return null;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$components$2f$SegmentRuleBuilder$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildRulesJson"])(segment.name, segment.rules_json);
        }
    }["SegmentEditPage.useMemo[rulesJsonOutput]"], [
        segment
    ]);
    // ── Derive validation ──────────────────────────────────────────────
    const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SegmentEditPage.useMemo[validation]": ()=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$components$2f$SegmentRuleBuilder$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateRules"])(segment.rules_json.rules);
        }
    }["SegmentEditPage.useMemo[validation]"], [
        segment
    ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            showJsonPreview && rulesJsonOutput && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SegmentEditPage, "8/7GG9Z+NU161Sey+yePzBZIxzU=", false, function() {
    return [
...
//# sourceMappingURL=src_631ae764._.js.map