 ...
 */ function toKDSRole(roleId) {
    if (roleId === 'KDS_USER' || roleId === 'STORE_MANAGER') {
        return roleId;
    }
    return undefined;
}
const useKDSAccessStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((set, get)=>({
        ...
        hasPermission: (permission)=>{
            ...
            // STORE_MANAGER inherits all permissions via the existing RBAC model
            // (every can* helper in kdsAccess.ts returns true for STORE_MANAGER)
...
//# sourceMappingURL=src_75eb02df._.js.map