...
const POSProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSProvider.useEffect": ()=>{
            ...
            if (platformStoreId && !session) {
                ...
                const store = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$mock$2f$posData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockStores"].find({
                    "POSProvider.useEffect": (s)=>s.id === 'S001'
                }["POSProvider.useEffect"]) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$mock$2f$posData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockStores"][0];
                const user = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$mock$2f$posData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPOSUsers"][0]; // Default to first mock manager
                const autoSession = {
                    user,
                    posType: 'STORE',
                    store,
    ...
    const startShift = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSProvider.useCallback[startShift]": (openingCash, notes)=>{
            if (!session) return;
            setIsSyncing(true);
            const shift = {
            ...
            // Simulate sync delay
            setTimeout({
                "POSProvider.useCallback[startShift]": ()=>{
                    updateSession({
                        ...session,
                        shift
                    });
            ...
            }["POSProvider.useCallback[startShift]"], 2000);
        }
    }["POSProvider.useCallback[startShift]"], [
        session,
        updateSession
...
_s(POSProvider, "zXjyiY7QzZj1KYYAivlI7bERPrA=", false, function() {
    return [
...
"[project]/src/modules/pos/components/ShiftOpeningModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ShiftOpeningModal = ()=>{
    _s();
    const { session, startShift, isSyncing } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$context$2f$POSContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePOS"])();
    const [openingCash, setOpeningCash] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShiftOpeningModal.useEffect": ()=>{
            setCurrentTime(new Date().toLocaleString());
            const timer = setInterval({
                "ShiftOpeningModal.useEffect.timer": ()=>{
                    setCurrentTime(new Date().toLocaleString());
                }
            }["ShiftOpeningModal.useEffect.timer"], 60000);
            return ({
                "ShiftOpeningModal.useEffect": ()=>clearInterval(timer)
            })["ShiftOpeningModal.useEffect"];
        }
    }["ShiftOpeningModal.useEffect"], []);
...
_s(ShiftOpeningModal, "zwb06u/vUuN4yiuyLXO7XZMd3aU=", false, function() {
    return [
...
_c = ShiftOpeningModal;
var _c;
__turbopack_context__.k.register(_c, "ShiftOpeningModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/modules/pos/components/SyncingLoader.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SyncingLoader = ()=>{
    _s();
    const { isSyncing } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$context$2f$POSContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePOS"])();
...
_s(SyncingLoader, "LukisUyx3JZuPo85yGhvNtR9qco=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$context$2f$POSContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePOS"]
    ];
});
_c = SyncingLoader;
var _c;
__turbopack_context__.k.register(_c, "SyncingLoader");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$components$2f$SyncingLoader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/pos/components/SyncingLoader.tsx [app-client] (ecmascript)");
'use client';
;
;
;
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$context$2f$POSContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["POSProvider"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$pos$2f$components$2f$SyncingLoader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SyncingLoader"], {}, void 0, false, {
                            fileName: "[project]/src/app/pos/layout.tsx",
                            lineNumber: 18,
                            columnNumber: 25
                        }, this)
...
//# sourceMappingURL=_6a3d229f._.js.map