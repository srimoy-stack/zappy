        ...
        recallFulfilledOrder: (orderId)=>{
            set((state)=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$services$2f$kdsAuditLogger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logKDSAction"])('order.reopened', {
                    orderId: recalledOrder.id,
                    orderNumber: recalledOrder.orderNumber,
                    previousStage: orderToRecall.stage
                });
                return {
                    orders: {
                        ...state.orders,
...
;
/**
 * Helper to get default permissions based on role as per section 4.4
...
async function mockKDSBootstrap() {
    // Simulate network latency (will be replaced with real GET /api/kds/bootstrap)
    ...
    const roleId = "STORE_MANAGER"; // Change this to test different roles
    return {
        user: {
            user_id: "mock-user-1",
            role_id: roleId,
...
async function bootstrapKDS() {
    const data = await mockKDSBootstrap();
    ...
    // 2. Hydrate KDS Store (Orders + Routing Rules)
    ...
    if (Object.keys(data.routing_rules).length > 0) {
    ...
    if (Object.keys(data.sound_config).length > 0) {
    ...
    // 4. Reset Filter Store (Initial clean state for new session)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$services$2f$kdsEventDispatcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["configureDispatcher"])({
        tenantId: data.user.brand_id,
        storeId: data.user.store_id
    });
    console.info(`[KDSBootstrap] Mock bootstrap complete for ${data.user.user_id}`);
    return data;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
async function pairStation(pairingCode) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$services$2f$mockStationService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pairStation"])(pairingCode);
    console.info(`[StationDevice] Paired successfully — station: "${result.station_id}", token: "${result.station_token.slice(0, 12)}…"`);
    return result;
}
...
//# sourceMappingURL=src_18deb2c3._.js.map