...
const KDSFooter = ({ totalPages = 1 })=>{
    ...
    const { stage: currentStage, setStage, currentPage, setCurrentPage, fulfillment, source } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$useFilterStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilterStore"])();
    ...
    const baseFilteredOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "KDSFooter.useMemo[baseFilteredOrders]": ()=>{
            return Object.values(ordersMap).filter({
                "KDSFooter.useMemo[baseFilteredOrders]": (o)=>{
                    const matchesFulfillment = fulfillment === 'ALL' || o.fulfillment_type === fulfillment;
                    const matchesSource = source === 'ALL' || o.order_source === source;
                    if (!matchesFulfillment || !matchesSource) return false;
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$routingUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isOrderVisibleOnStation"])(o, config);
                }
            }["KDSFooter.useMemo[baseFilteredOrders]"]);
        }
    }["KDSFooter.useMemo[baseFilteredOrders]"], [
    ...
    const baseFilteredCompleted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "KDSFooter.useMemo[baseFilteredCompleted]": ()=>{
            return fulfilledOrders.filter({
                "KDSFooter.useMemo[baseFilteredCompleted]": (o)=>{
                    const matchesFulfillment = fulfillment === 'ALL' || o.fulfillment_type === fulfillment;
                    const matchesSource = source === 'ALL' || o.order_source === source;
                    if (!matchesFulfillment || !matchesSource) return false;
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$routingUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isOrderVisibleOnStation"])(o, config);
    ...
    const counts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "KDSFooter.useMemo[counts]": ()=>({
                ...
                queue: baseFilteredOrders.filter({
                    "KDSFooter.useMemo[counts]": (o)=>o.stage === 'NEW'
                }["KDSFooter.useMemo[counts]"]).length,
                cooking: baseFilteredOrders.filter({
                    "KDSFooter.useMemo[counts]": (o)=>o.stage === 'FIRED'
                }["KDSFooter.useMemo[counts]"]).length,
                packing: baseFilteredOrders.filter({
                    "KDSFooter.useMemo[counts]": (o)=>o.stage === 'READY'
                }["KDSFooter.useMemo[counts]"]).length,
                delayed: baseFilteredOrders.filter({
                    "KDSFooter.useMemo[counts]": (o)=>o.isDelayed
                }["KDSFooter.useMemo[counts]"]).length,
                completed: baseFilteredCompleted.length
            })
    }["KDSFooter.useMemo[counts]"], [
        baseFilteredOrders,
        baseFilteredCompleted
    ]);
...
_s(KDSFooter, "7XcQMqRe3EQDRcpW6+h0LE6S/BE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$useFilterStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilterStore"],
...
;
;
const KDSColumn = /*#__PURE__*/ _s(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].memo(_c = _s(({ title, stage, onViewDetail })=>{
    _s();
    ...
    const stageOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2f$shallow$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useShallow"])({
        "KDSColumn.useKDSStore[stageOrders]": (state)=>Object.values(state.orders).filter({
                "KDSColumn.useKDSStore[stageOrders]": (o)=>{
                    ...
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$utils$2f$routingUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isOrderVisibleOnStation"])(o, {
                        enable_station_routing,
                        selectedStationId,
                        category_station_map,
                        allow_item_station_override,
...
}, "63H76CnnU/D3eDmE797br0MaMlU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$useFilterStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFilterStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"]
...
const OrderDetailModal = ({ order, isOpen, onClose })=>{
    ...
    const { cancelOrder, toggleItemCompletion } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"])();
...
_s(OrderDetailModal, "+q1q4m3xSpWwmdaAG3osPVHmpBQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"],
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: viewMode === 'SUMMARY' || viewMode === 'ALL_DAY' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: viewMode === 'KANBAN' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex gap-4 h-full p-4 overflow-x-auto overflow-y-hidden scrollbar-hide",
                                        children: [
                                        ...
                                        lineNumber: 350,
                                        columnNumber: 37
                                    }, this) : viewMode === 'GRID' || viewMode === 'COMPACT' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "h-full overflow-y-auto p-4 scrollbar-hide",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: `grid gap-4 ${viewMode === 'GRID' ? 'grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5' : 'grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8'}`,
...
_s(KDSMasterPage, "NWVuufb2ELGYtTZIUSgQmAxFf5s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$providers$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useKDSStore"],
...
//# sourceMappingURL=src_a24a971b._.js.map