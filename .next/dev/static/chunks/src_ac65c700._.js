...
_s(CheckoutForm, "R0kLLEBdSANkHJPQGtM19pM31fc=");
_c = CheckoutForm;
;
var _c;
...
"[project]/src/app/shop/checkout/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CheckoutContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CheckoutContent.useEffect": ()=>{
            ...
            const load = {
                "CheckoutContent.useEffect.load": async ()=>{
                    setLoading(true);
            ...
            }["CheckoutContent.useEffect.load"];
            load();
        }
    }["CheckoutContent.useEffect"], [
        itemId,
    ...
    const handleSuccess = async (email)=>{
        if (!item) return;
        // Mock order creation
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$shop$2f$services$2f$shopService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shopService"].createOrder(item, email);
        router.push(`/shop/success?orderId=${order.orderId}`);
    };
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CheckoutContent, "E1VAnyDSdmVsL4NKFkoziK0x/xE=", false, function() {
    return [
...
//# sourceMappingURL=src_ac65c700._.js.map