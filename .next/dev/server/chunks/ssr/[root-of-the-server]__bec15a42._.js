...
const EmailCampaignsPage = ()=>{
    ...
    const handleDuplicate = async (campaign)=>{
        ...
        try {
            ...
            toast.success('Campaign duplicated', `"${campaign.name} (Copy)" created.`);
            refetch();
        } catch (err) {
    ...
    const handlePause = async (id)=>{
        ...
        try {
            ...
            toast.success('Campaign paused', 'The delivery process has been halted.');
            refetch();
        } catch (err) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$email$2d$campaigns$2f$components$2f$ConfirmModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ConfirmModal"], {
                ...
                description: confirmAction?.type === 'archive' ? `Are you sure you want to archive "${confirmAction?.name}"? It will be removed from your active dashboard.` : `This will immediately stop delivery for "${confirmAction?.name}". Any emails already in the sending queue might still be delivered.`,
                confirmLabel: confirmAction?.type === 'archive' ? 'Archive' : 'Pause Now',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bec15a42._.js.map