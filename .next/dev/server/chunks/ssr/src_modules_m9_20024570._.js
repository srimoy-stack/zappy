module.exports = [
"[project]/src/modules/m9/mock/items.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/mock/finances.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/mock/employeesData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/mock/customers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/mock/cash-variance.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/mock/inventory.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/services/inventoryService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
let inventoryEntries = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$mock$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockInventoryEntries"]
];
let inventoryItems = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$mock$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockInventoryItems"]
];
let recipes = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$mock$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockRecipes"]
];
let vendors = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$mock$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockVendors"]
];
let inventoryReturns = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$mock$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockInventoryReturns"]
];
let inventoryLedger = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$mock$2f$inventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockInventoryLedger"]
];
// Helper: Generate ID
...
"[project]/src/modules/m9/services/userService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/services/businessOperationsService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/services/integrationsService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/m9/services/externalOrdersService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const externalOrdersService = {
    ...
    retryNormalization: async (orderId)=>{
    ...
    archiveOrder: async (orderId)=>{
        ...
        store = store.map((o)=>o.id === orderId ? {
                ...o,
                isArchived: true
            } : o);
    }
...
"[project]/src/modules/m9/utils/mappingUtils.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function calculateSimilarity(str1, str2) {
    ...
    for(let j = 1; j < height; j++){
        for(let i = 1; i < width; i++){
            ...
            matrix[j * width + i] = Math.min(matrix[j * width + (i - 1)] + 1, matrix[(j - 1) * width + i] + 1, matrix[(j - 1) * width + (i - 1)] + indicator);
        }
    }
...
function getAutoSuggestion(targetName, sourceList, threshold = 0.7) {
    let bestMatch = null;
    let highestScore = 0;
...
//# sourceMappingURL=src_modules_m9_20024570._.js.map