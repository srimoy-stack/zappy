...
function getCompliantHtml(html) {
    ...
    // If missing any mandatory tag, append the default footer
    // We append it inside a specific div if we want to be fancy, 
    // but simple string append is safest for random HTML structures.
...
const TemplateEditor = ({ initialData, onSave, onCancel })=>{
    ...
    const previewHtml = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        // Auto-inject footer if mandatory tags are missing in the user-provided body
    ...
    // Compliance Check
    const compliance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>validateCompliance(previewHtml), [
        previewHtml
    ]);
    const unknownVars = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>getUnknownVariables(formData.htmlBody), [
        formData.htmlBody
    ]);
    const handleSave = ()=>{
        ...
        const finalValidation = validateCompliance(previewHtml);
        if (!finalValidation.valid) {
            toast.error('Compliance Block', 'Template must include required compliance footer.');
            return;
        }
        onSave({
            ...formData,
            // Ensure the saved HTML body is used, but we might want to warn or suggest 
            // the user that we are adding the footer for them if they haven't.
            // Requirement says: "No invalid email can be created".
            // So we save the compliant version.
            htmlBody: formData.htmlBody.includes('{{unsubscribe_url}}') ? formData.htmlBody : getCompliantHtml(formData.htmlBody),
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    dangerouslySetInnerHTML: {
                                                        __html: getCompliantHtml(tpl.htmlBody)
                                                    }
                                                }, void 0, false, {
                                                    fileName: "[project]/src/modules/m9/email-campaigns/pages/TemplatesPage.tsx",
                                                    lineNumber: 598,
...
//# sourceMappingURL=src_4de7526e._.js.map