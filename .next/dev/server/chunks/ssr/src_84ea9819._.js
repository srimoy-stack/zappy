...
function OrderTicket({ order, variant = 'standard' }) {
    ...
    const { delayOrder, advanceStage, acceptOrder, sendCustomerMessage, cancelOrder } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useKDSStore"])();
    const { playSound } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$components$2f$sound$2f$useKDSSound$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useKDSSound"])();
    ...
    const getBorderState = ()=>{
        ...
        if (slaState === 'OVERDUE') return 'border-[var(--kds-status-late)] border-[6px]';
        if (slaState === 'WARNING') return 'border-[var(--kds-status-warning)] border-[6px]';
        if (order.stage === 'ACCEPTED') return 'border-[var(--kds-status-new)] border-[6px]';
        if (order.stage === 'PREPARATION' || order.stage === 'CUTTING') return 'border-[var(--kds-status-prep)] border-[6px]';
        if (order.stage === 'READY') return 'border-[var(--kds-status-complete)] border-[2px]';
        return 'border-[var(--kds-border)] border-[2px]';
    };
                                ...
                                order.items.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-[var(--kds-font-main)] text-[var(--kds-font-item)] font-black text-white leading-none mt-1",
                                                        children: "1x"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/modules/kds/components/ticket/OrderTicket.tsx",
                                                        lineNumber: 332,
...
const KDSColumn = ({ title, stage })=>{
    ...
    const stageOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$kds$2f$store$2f$kdsStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useKDSStore"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2f$shallow$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useShallow"])((state)=>Object.values(state.orders).filter((o)=>{
            ...
            // 3. Delivery vs Dine-in SLA Tension
            // If a delivery is within 2 minutes of breaching, it jumps above dine-in of same state
            ...
            if (isADelivery && aRemaining < 120 && !isBDelivery) return -1;
            if (isBDelivery && bRemaining < 120 && !isADelivery) return 1;
            // 4. Oldest First (Default)
...
//# sourceMappingURL=src_84ea9819._.js.map