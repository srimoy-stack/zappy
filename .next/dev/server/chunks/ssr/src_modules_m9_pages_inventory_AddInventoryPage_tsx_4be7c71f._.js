module.exports = [
"[project]/src/modules/m9/pages/inventory/AddInventoryPage.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AddInventoryPage = ()=>{
    ...
    const [inventoryDate, setInventoryDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Date().toISOString().split('T')[0]);
    const [inventoryStatus, setInventoryStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('Draft');
    ...
    const [shippingCharges, setShippingCharges] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const loadData = async ()=>{
        try {
            const [vData, iData] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vendorService"].getAll(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["inventoryItemService"].getAll({
                    status: 'Active'
                })
            ]);
            setVendors(vData);
    ...
    const handleCreateVendor = async ()=>{
        ...
        try {
            const newVendor = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vendorService"].create({
                name: newVendorName,
    ...
    const handleSave = async (status = 'Draft')=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$m9$2f$services$2f$inventoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["inventoryService"].createEntry(payload, 'USER001', 'Admin User');
...
//# sourceMappingURL=src_modules_m9_pages_inventory_AddInventoryPage_tsx_4be7c71f._.js.map