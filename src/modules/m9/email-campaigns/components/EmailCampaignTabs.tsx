...
import { Mail, FileText, BarChart3, Users, LayoutDashboard, Contact2, ShieldAlert } from 'lucide-react';
...
export const EmailCampaignTabs: React.FC = () => {
    ...
    return (
        <nav className="flex items-center gap-1 bg-slate-100/80 p-1 rounded-2xl w-fit">
            {TABS.map((tab) => {
