                    ...
                    <div className="max-w-7xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    {kds_stations.map((station, idx) => (
                                        <div key={station.station_id} className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex items-center gap-4 group">
                                            <div className="w-10 h-10 rounded-xl bg-gray-50 text-gray-400 flex items-center justify-center font-black text-xs">{idx + 1}</div>
                                            <input
                                                type="text"
                                    ...
                                    <table className="w-full text-left border-collapse">
                                        <thead>
                                            <tr className="bg-gray-50 border-b border-gray-200">
                                                <th className="px-6 py-4 text-[10px] font-bold uppercase text-gray-400">Source Category</th>
                                                <th className="px-6 py-4 text-[10px] font-bold uppercase text-gray-400">Target Node</th>
                                            </tr>
                                        </thead>
                                        <tbody className="divide-y divide-gray-100">
                                            {categories.map((catId) => (
                                                <tr key={catId} className="hover:bg-gray-50/50 transition-colors">
                                                    <td className="px-6 py-4"><span className="text-xs font-bold text-gray-900 uppercase">{catId}</span></td>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden max-h-[600px] overflow-y-auto scrollbar-hide">
                                    <table className="w-full text-left border-collapse">
                                        <thead>
                                            <tr className="bg-gray-50 border-b border-gray-200">
                                                <th className="px-6 py-4 text-[10px] font-bold uppercase text-gray-400">SKU Name</th>
                                                <th className="px-6 py-4 text-[10px] font-bold uppercase text-gray-400">Override Node</th>
                                            </tr>
                                        </thead>
                                        <tbody className="divide-y divide-gray-100">
                                            {items.map((itemName) => (
                                                <tr key={itemName} className="hover:bg-gray-50/50 transition-colors">
                                                    <td className="px-6 py-4"><span className="text-xs font-bold text-gray-900 uppercase truncate max-w-[150px] block">{itemName}</span></td>
                                                    <td className="px-6 py-4">
                                                        <select
